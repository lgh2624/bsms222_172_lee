...
d1 %>%
  ...
  scale_y_discrete(limits = rev(levels(organ_axis)),
                   labels = rev(c('BM&I', 'B&C', 'Ear', 'E&M', 'Eye', 'Face', 'GIT', 'H/L/CV', 'KRT', 'MC', 'SK', 'Skin', 'SC/PN', 'T&D'))) +
  scale_fill_manual(name = 'organ', values = organ_axis, labels = paste(c('BM&I', 'B&C', 'Ear', 'E&M', 'Eye', 'Face', 'GIT', 'H/L/CV', 'KRT', 'MC', 'SK', 'Skin', 'SC/PN', 'T&D'), organ_axis, sep = ': ')) +
  coord_fixed(ratio = 0.25)
```
